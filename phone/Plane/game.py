...
# 英雄
left_image = pygame.image.load('image/bullet_left.png')
single_image = pygame.image.load('image/bullet_straight.png')
right_image = pygame.image.load('image/bullet_right.png')
triple_left = pygame.image.load('image/triple_left.png')
triple_right = pygame.image.load('image/triple_right.png')
...
# 敌人
down_bullet_image_1 = pygame.image.load('image/down_bullet.png')
down_left_bullet_image_1 = pygame.image.load('image/triple_left_down.png')
down_right_bullet_image_1 = pygame.image.load('image/triple_right_down.png')
down_bullet_image_2 = pygame.image.load('image/bullet_04.png')
...
enemy_image_1 = pygame.image.load('image/img-plane_3.png')
enemy_image_2 = pygame.image.load('image/img-plane_7.png')
enemy_image_3 = pygame.image.load('image/img-plane_1.png')
...
box_shield = pygame.image.load('image/box_shield.png')
box_double = pygame.image.load('image/box_double.png')
box_triple = pygame.image.load('image/box_triple.png')
box_life = pygame.image.load('image/box_life.png')
...
class Level(Phone):
	def __init__(self):
		...
		self.pause_off = pygame.image.load('image/pause_off.png')
		self.assist_image = pygame.image.load('image/assist.png')
		self.assist_gray = pygame.image.load('image/assist_gray.png')
		...
		# 字体
		self.font2 = pygame.font.Font('font/汉仪超级战甲.ttf', 20)
		self.start = self.font2.render('开始游戏', True, white)
		self.start_rect = self.start.get_rect()

		self.font3 = pygame.font.Font('font/汉仪超级战甲.ttf', 30)
	...
	def run(self):
		...
		while not self.quit:
			...
			# draw
				...
				print('hero: %d'%self.hero.life, '\n')
				if enemy_list:
					print('enemy(%d): %d'%(len(enemy_list), enemy_list[0].life), '\n')
				print('time: %d'%(self.curr_time-self.start_time), '\n')
