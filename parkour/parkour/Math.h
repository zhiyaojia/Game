...
public:
	...
	friend Quaternion operator*(float scalar, const Quaternion& vec)
	{
		return Quaternion(vec.x * scalar, vec.y * scalar, vec.z * scalar, vec.w * scalar);
	}
...
namespace Color
{
	...
	static const Vector3 DarkRed(0.65f, 0.0f, 0.0f);
